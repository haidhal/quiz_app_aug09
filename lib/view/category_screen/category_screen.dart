      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Column(crossAxisAlignment: CrossAxisAlignment.start,
            ...
            SizedBox(height: 5,),
             Text("Let's make the day productive",
            style: TextStyle(
          ...
          actions: [
            CircleAvatar(
              backgroundImage: NetworkImage("https://i.pinimg.com/564x/b1/88/c6/b188c6801ad1d71d3c962c6e4aa2d0cf.jpg"),
            ),
            SizedBox(width: 12,)
          ],
        ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                       Icon(Icons.access_alarm_rounded,size: 50,), // lottie
                       SizedBox(width: 15,),
                       ...
                       SizedBox(width:20 ,),
                       Icon(Icons.circle,size: 50,), // lottie
                       SizedBox(width: 15,),
                       Column(crossAxisAlignment: CrossAxisAlignment.start,
                       mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    child: Column(
                                      ...
                                      fontWeight: FontWeight.w500
                                       ...
                                       Text(DummyDb.categories[index]["questionNo"],
                                       style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 15
                                     ),
